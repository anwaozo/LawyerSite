					...
					<div className="row">
						...
						<div className="col-6">
							...
							>
								<div className="feature-icon">
									<img
										src="/images/icons/negotiation.svg"
										width=""
										height=""
										loading="lazy"
										decoding="async"
						...
						<div className="col-6">
							...
							>
								...
								<h4>CORPORATE LAW</h4>
								<p>
									Successfully maneuvering through the complex
									terrain of corporate and commercial law
									demands a deep comprehension of business
									operations. We provide guidance in areas
									spanning entity establishment, contract
									composition, and navigating mergers and
									acquisitions. Our aim is to empower clients
									to make well-informed choices, mitigate
									potential risks, and seize advantages within
